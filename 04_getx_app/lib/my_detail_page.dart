          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Container(
                  margin: const EdgeInsets.only(left: 15, top: 20, bottom: 20, right: 15),
                  child: Column(
                    children: [
                      Row(
                        children: [
                      ...
                      Row(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              const Icon(Icons.watch_later, color: Color(0xFF69c5df)),
                              const SizedBox(
                                width: 3,
                              ),
                              Column(
                                ...
                                children: [
                                  Text(
                                    Get.arguments['name'],
                                    style: const TextStyle(
                                        fontSize: 18, color: Color(0xFF303030), fontWeight: FontWeight.w700),
                                  ),
                                  Text(
                                    Get.arguments['time'],
                                    style: const TextStyle(fontSize: 18, color: Color(0xFFacacac)),
                                  )
                                ],
                              )
                            ],
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              const Icon(Icons.monetization_on, color: Color(0xFFfb8483)),
                              const SizedBox(
                                width: 3,
                              ),
                              Column(
                              ...
                              Column(
                                ...
                                children: const [
                                  Text(
                                    "Top Level",
                                    style:
                                        TextStyle(fontSize: 18, color: Color(0xFF303030), fontWeight: FontWeight.w700),
                                  ),
                                  Text(
                                    "Entry",
                                    style: TextStyle(fontSize: 18, color: Color(0xFFacacac)),
